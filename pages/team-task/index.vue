...
<view class="team-task  p-tb-20 p-lr-30">
    <view v-if="isShow404">
        <view class="top-view">
            <view class="t-view">
                <view class="money">
                    <text :class="list.mission_status === 2 ? 'tr' : 'td'">{{status[list.mission_status]}}</text>
                </view>
        ...
        <view class="card p-lr-20 m-tb-20 p-bottom-20">
            ...
            <view class="main p-top-20" v-if="index === 0">
                ...
                <view class="item">任务周期：{{ list.mission_start_time }} 至
                    {{ list.mission_end_time }}
                </view>
            ...
            <view class="main p-top-20" v-if="index === 1">
                <view class="item_table" v-for="(n, i) in users" :key="i">
                    ...
                    <view :class="i === 5 ? 'content' : 'content min-border-bottom'">
                        ...
                        <view style="width:33%;text-align:right">{{ n.ident }}</view>
