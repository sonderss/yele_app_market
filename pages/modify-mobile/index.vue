...
<view class="modify-mobile p-lr-30 p-tb-20">
    <view class="min-view-item min-flex min-flex-main-between f28 min-border-bottom">
        ...
        <view class="right-view">
            <input class="oinput p-left-30" type="number" placeholder="输入新手机号" maxlength="11" v-model="new_mobile" />
    ...
    <view class="inp min-flex min-flex-main-between min-border-bottom">
        <view class="min-view-item min-flex min-flex-main-between f28 min-border-bottom">
            ...
            <view class="right-view">
                <input class="oinput p-left-30" type="number" placeholder="请输入验证码" maxlength="6" v-model="msg_code" />
            </view>
        </view>

    </view>
    <min-btn class="m-top-30" style="margin-top:80rpx" @click="SetPhone">完成</min-btn>
</view>
</template>
