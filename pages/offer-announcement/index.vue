...
<view class="offer-announcement p-lr-20 p-tb-20">
    <view class="card">
        <view :class="index !== list.length - 1 ? 'item min-border-bottom' : 'item'" v-for="(item, index) in list" :key="item.id" @click="toDetail(item.id)">
    ...
    <min-drawer :visible="showdrawer" mode="right" @close="closedrawer" @changeStore="changeStoreId" :isT="false"></min-drawer>
</view>
</template>
