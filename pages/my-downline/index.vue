...
<view class="my-downline p-lr-20 p-tb-20">
    <min-search v-model="value" placeholder="请输入营销姓名/手机号搜索" bgColor='#eee' borderRadius="30rpx"></min-search>
    <view class="mid-view">
        ...
        <view class="right-view">
            <text class="txt" style="color:#FE0000"><text class='f26' style="color:#FE0000">￥</text>{{list.total_rebate}}</text>
