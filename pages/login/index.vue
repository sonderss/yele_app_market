<template>
  <view class="login">
    ...
    <view class="m-lr-30 p-lr-30">
      <view
        class="inp p-left-30 min-flex min-flex-main-start min-border-bottom"
      >
      ...
      <view
        class="inp p-left-30 min-flex min-flex-main-between min-border-bottom"
      >
        ...
        <view class="code" @click="getVerificationCode" v-if="countDown === 0"
          >获取验证码</view
        >
