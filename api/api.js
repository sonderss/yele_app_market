...
export default {
  ...
  // 请求绑定 getCnm 5f028567de953
  getBangding: data => minRequest.post('/5f028567de953', data),
  // 绑定银行卡 5edf3db074e13
  ...
  // 提现  5f28e48572deb
  getTxian: data => minRequest.get('/5f28e48572deb', data),
  // 提现申请 5f278de718aec
  tixianshenqing: data => minRequest.post('/5f278de718aec', data)
}
